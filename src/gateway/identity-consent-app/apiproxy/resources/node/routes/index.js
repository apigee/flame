...
exports.create = function(req, res) {
    ...
    if (error != null) {
        ...
        res.redirect(req.query.hostName + "/openid/saveUser?sessionid=" + sessionid);
    }
};
...
exports.myapps = function(req, res) {
    ...
    if (req.query.open_id == "true") {
      //Modified this value to navaigate back from myapps to consent page.
	   redirect_uri = "/openid/index?sessionid="+req.query.sessionid;
    } else {
        redirect_uri = "/openid/index";
    }
    var applications = [];
...
exports.Profile = function(req, res) {
    if (req.query.open_id == "true") {
        ...
        redirect_uri = "/openid/logout" //Modified the redicte url to handle session and logout.
    }
